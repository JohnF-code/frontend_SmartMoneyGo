...
const TodayLoansModal = ({ showModal, setShowModal, prestamos }) => {
  const handleClose = () => {
    setShowModal(false);
  }
        ...
        <DialogPanel className="relative z-10 bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <ul className="p-4 overflow-y-auto max-h-80">
            {prestamos && prestamos.length > 0 ? (
              ...
              <li className="p-2 text-sm font-medium text-gray-500">No hay préstamos registrados hoy.</li>
            )}
          </ul>
        </DialogPanel>
      </Dialog>
...
export default TodayLoansModal;
